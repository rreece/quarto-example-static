...
NOTE: The above equation doesn't work when making a pdf.
See [this issue](https://github.com/quarto-dev/quarto-cli/issues/2275).
Instead, for pdf we do the following with
...
But notice that the previous time I refrenced Maxwell's equations (@eq-maxwell),
and this time, the reference works for html but is broken in pdf.
